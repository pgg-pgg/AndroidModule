...
public class NetworkUtils {
    ...
    public static boolean isAvailableByPing(){
        ShellUtils.CommandResult commandResult = ShellUtils.execCmd("ping -c 1 -w 1 223.5.5.5", false);
        boolean ret = commandResult.result == 0;
        if (commandResult.errorMsg != null) {
            Logger.d("isAvailableByPing errorMsg", commandResult.errorMsg);
        }
        if (commandResult.successMsg != null) {
            Logger.d("isAvailableByPing successMsg", commandResult.successMsg);
        }
        return ret;
    }
    /**
    ...
    public static boolean getDataEnabled(){
        try {
            ...
            Method getDataEnabled = manager.getClass().getDeclaredMethod("getDataEnabled");
            if (null!=getDataEnabled){
                return (boolean)getDataEnabled.invoke(manager);
            }
        }catch (Exception e){
            e.printStackTrace();
        }
