...
public class NewsDetailView extends FrameLayout implements NewsDetailContract.View {
    ...
    public NewsDetailView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public NewsDetailView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    public void showNewsDetail(MessageDetail detail) {
        ...
        Glide.with(getContext()).load(detail.getImage()).thumbnail(0.2f).into(mToolbarImage);
